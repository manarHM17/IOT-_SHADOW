...
class GetDevicesRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:provisioning.GetDevicesRequest) */ {
 public:
  ...
  void MergeFrom( const GetDevicesRequest& from) {
    GetDevicesRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg);
  public:
...
// string jwt_token = 2;
inline void DeleteDeviceRequest::clear_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.jwt_token_.ClearToEmpty();
}
inline const std::string& DeleteDeviceRequest::jwt_token() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:provisioning.DeleteDeviceRequest.jwt_token)
  return _internal_jwt_token();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void DeleteDeviceRequest::set_jwt_token(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.jwt_token_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:provisioning.DeleteDeviceRequest.jwt_token)
}
inline std::string* DeleteDeviceRequest::mutable_jwt_token() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_jwt_token();
  // @@protoc_insertion_point(field_mutable:provisioning.DeleteDeviceRequest.jwt_token)
  return _s;
}
inline const std::string& DeleteDeviceRequest::_internal_jwt_token() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.jwt_token_.Get();
}
inline void DeleteDeviceRequest::_internal_set_jwt_token(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.jwt_token_.Set(value, GetArena());
}
inline std::string* DeleteDeviceRequest::_internal_mutable_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.jwt_token_.Mutable( GetArena());
}
inline std::string* DeleteDeviceRequest::release_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:provisioning.DeleteDeviceRequest.jwt_token)
  return _impl_.jwt_token_.Release();
}
inline void DeleteDeviceRequest::set_allocated_jwt_token(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.jwt_token_.SetAllocated(value, GetArena());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.jwt_token_.IsDefault()) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:provisioning.DeleteDeviceRequest.jwt_token)
}
...
// string jwt_token = 3;
inline void UpdateDeviceRequest::clear_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.jwt_token_.ClearToEmpty();
}
inline const std::string& UpdateDeviceRequest::jwt_token() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:provisioning.UpdateDeviceRequest.jwt_token)
  return _internal_jwt_token();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void UpdateDeviceRequest::set_jwt_token(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.jwt_token_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:provisioning.UpdateDeviceRequest.jwt_token)
}
inline std::string* UpdateDeviceRequest::mutable_jwt_token() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_jwt_token();
  // @@protoc_insertion_point(field_mutable:provisioning.UpdateDeviceRequest.jwt_token)
  return _s;
}
inline const std::string& UpdateDeviceRequest::_internal_jwt_token() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.jwt_token_.Get();
}
inline void UpdateDeviceRequest::_internal_set_jwt_token(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.jwt_token_.Set(value, GetArena());
}
inline std::string* UpdateDeviceRequest::_internal_mutable_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.jwt_token_.Mutable( GetArena());
}
inline std::string* UpdateDeviceRequest::release_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:provisioning.UpdateDeviceRequest.jwt_token)
  return _impl_.jwt_token_.Release();
}
inline void UpdateDeviceRequest::set_allocated_jwt_token(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.jwt_token_.SetAllocated(value, GetArena());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.jwt_token_.IsDefault()) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:provisioning.UpdateDeviceRequest.jwt_token)
}
...
// string jwt_token = 1;
inline void GetDevicesRequest::clear_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.jwt_token_.ClearToEmpty();
}
inline const std::string& GetDevicesRequest::jwt_token() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:provisioning.GetDevicesRequest.jwt_token)
  return _internal_jwt_token();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void GetDevicesRequest::set_jwt_token(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.jwt_token_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:provisioning.GetDevicesRequest.jwt_token)
}
inline std::string* GetDevicesRequest::mutable_jwt_token() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_jwt_token();
  // @@protoc_insertion_point(field_mutable:provisioning.GetDevicesRequest.jwt_token)
  return _s;
}
inline const std::string& GetDevicesRequest::_internal_jwt_token() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.jwt_token_.Get();
}
inline void GetDevicesRequest::_internal_set_jwt_token(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.jwt_token_.Set(value, GetArena());
}
inline std::string* GetDevicesRequest::_internal_mutable_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.jwt_token_.Mutable( GetArena());
}
inline std::string* GetDevicesRequest::release_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:provisioning.GetDevicesRequest.jwt_token)
  return _impl_.jwt_token_.Release();
}
inline void GetDevicesRequest::set_allocated_jwt_token(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.jwt_token_.SetAllocated(value, GetArena());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.jwt_token_.IsDefault()) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:provisioning.GetDevicesRequest.jwt_token)
}
...
// string jwt_token = 2;
inline void GetDeviceByIdRequest::clear_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.jwt_token_.ClearToEmpty();
}
inline const std::string& GetDeviceByIdRequest::jwt_token() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:provisioning.GetDeviceByIdRequest.jwt_token)
  return _internal_jwt_token();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void GetDeviceByIdRequest::set_jwt_token(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.jwt_token_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:provisioning.GetDeviceByIdRequest.jwt_token)
}
inline std::string* GetDeviceByIdRequest::mutable_jwt_token() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_jwt_token();
  // @@protoc_insertion_point(field_mutable:provisioning.GetDeviceByIdRequest.jwt_token)
  return _s;
}
inline const std::string& GetDeviceByIdRequest::_internal_jwt_token() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.jwt_token_.Get();
}
inline void GetDeviceByIdRequest::_internal_set_jwt_token(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.jwt_token_.Set(value, GetArena());
}
inline std::string* GetDeviceByIdRequest::_internal_mutable_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  return _impl_.jwt_token_.Mutable( GetArena());
}
inline std::string* GetDeviceByIdRequest::release_jwt_token() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:provisioning.GetDeviceByIdRequest.jwt_token)
  return _impl_.jwt_token_.Release();
}
inline void GetDeviceByIdRequest::set_allocated_jwt_token(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.jwt_token_.SetAllocated(value, GetArena());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
        if (_impl_.jwt_token_.IsDefault()) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:provisioning.GetDeviceByIdRequest.jwt_token)
}
