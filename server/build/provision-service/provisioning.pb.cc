...
inline constexpr GetDevicesRequest::Impl_::Impl_(
    ::_pbi::ConstantInitialized) noexcept
      : jwt_token_(
            &::google::protobuf::internal::fixed_address_empty_string,
            ::_pbi::ConstantInitialized()),
...
const ::uint32_t TableStruct_provisioning_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    PROTOBUF_FIELD_OFFSET(::provisioning::DeleteDeviceRequest, _impl_.jwt_token_),
    ~0u,  // no _has_bits_
    ...
    PROTOBUF_FIELD_OFFSET(::provisioning::UpdateDeviceRequest, _impl_.jwt_token_),
    ~0u,
    0,
    ~0u,
    ~0u,  // no _has_bits_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::provisioning::GetDevicesRequest, _impl_.jwt_token_),
    ~0u,  // no _has_bits_
    ...
    PROTOBUF_FIELD_OFFSET(::provisioning::GetDeviceByIdRequest, _impl_.jwt_token_),
...
static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {37, -1, -1, sizeof(::provisioning::AddDeviceRequest)},
        {51, -1, -1, sizeof(::provisioning::AddDeviceResponse)},
        {63, -1, -1, sizeof(::provisioning::DeleteDeviceRequest)},
        {73, -1, -1, sizeof(::provisioning::DeleteDeviceResponse)},
        {83, 94, -1, sizeof(::provisioning::UpdateDeviceRequest)},
        {97, -1, -1, sizeof(::provisioning::UpdateDeviceResponse)},
        {107, -1, -1, sizeof(::provisioning::GetDevicesRequest)},
        {116, -1, -1, sizeof(::provisioning::GetDevicesResponse)},
        {125, -1, -1, sizeof(::provisioning::GetDeviceByIdRequest)},
        {135, 146, -1, sizeof(::provisioning::GetDeviceByIdResponse)},
};
...
const char descriptor_table_protodef_provisioning_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ...
    "\002 \001(\t\">\n\024DeleteDeviceResponse\022\017\n\007success"
    "\030\001 \001(\010\022\025\n\rerror_message\030\002 \001(\t\"j\n\023UpdateD"
    "eviceRequest\022\021\n\tdevice_id\030\001 \001(\005\022-\n\013devic"
    "e_info\030\002 \001(\0132\030.provisioning.DeviceInfo\022\021"
    "\n\tjwt_token\030\003 \001(\t\">\n\024UpdateDeviceRespons"
    "e\022\017\n\007success\030\001 \001(\010\022\025\n\rerror_message\030\002 \001("
    "\t\"&\n\021GetDevicesRequest\022\021\n\tjwt_token\030\001 \001("
    "\t\"\?\n\022GetDevicesResponse\022)\n\007devices\030\001 \003(\013"
    "2\030.provisioning.DeviceInfo\"<\n\024GetDeviceB"
    "yIdRequest\022\021\n\tdevice_id\030\001 \001(\005\022\021\n\tjwt_tok"
    "en\030\002 \001(\t\"i\n\025GetDeviceByIdResponse\022\017\n\007suc"
    "cess\030\001 \001(\010\022(\n\006device\030\002 \001(\0132\030.provisionin"
    "g.DeviceInfo\022\025\n\rerror_message\030\003 \001(\t2\206\004\n\023"
    "ProvisioningService\022E\n\014Authenticate\022\031.pr"
    "ovisioning.AuthRequest\032\032.provisioning.Au"
    "thResponse\022L\n\tAddDevice\022\036.provisioning.A"
    "ddDeviceRequest\032\037.provisioning.AddDevice"
    "Response\022U\n\014DeleteDevice\022!.provisioning."
    "DeleteDeviceRequest\032\".provisioning.Delet"
    "eDeviceResponse\022U\n\014UpdateDevice\022!.provis"
    "ioning.UpdateDeviceRequest\032\".provisionin"
    "g.UpdateDeviceResponse\022R\n\rGetAllDevices\022"
    "\037.provisioning.GetDevicesRequest\032 .provi"
    "sioning.GetDevicesResponse\022X\n\rGetDeviceB"
    "yId\022\".provisioning.GetDeviceByIdRequest\032"
    "#.provisioning.GetDeviceByIdResponseb\006pr"
    "oto3"
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<3, 8, 0, 100, 2> DeviceInfo::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // string updated_at = 8;
    {::_pbi::TcParser::FastUS1,
     {66, 63, 0, PROTOBUF_FIELD_OFFSET(DeviceInfo, _impl_.updated_at_)}},
    // int32 id = 1;
    ...
    // string created_at = 7;
    {::_pbi::TcParser::FastUS1,
     {58, 63, 0, PROTOBUF_FIELD_OFFSET(DeviceInfo, _impl_.created_at_)}},
  }}, {{
    65535, 65535
  }}, {{
    // int32 id = 1;
  ...
  // no aux_entries
  {{
    "\27\0\10\4\10\15\7\12\12\0\0\0\0\0\0\0"
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<3, 6, 0, 86, 2> AddDeviceRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
...
DeleteDeviceRequest::DeleteDeviceRequest(
  ...
  // @@protoc_insertion_point(copy_constructor:provisioning.DeleteDeviceRequest)
}
inline PROTOBUF_NDEBUG_INLINE DeleteDeviceRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 50, 2> DeleteDeviceRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    2, 8,  // max_field_number, fast_idx_mask
    ...
    // string jwt_token = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(DeleteDeviceRequest, _impl_.jwt_token_)}},
    // int32 device_id = 1;
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
    // string jwt_token = 2;
    {PROTOBUF_FIELD_OFFSET(DeleteDeviceRequest, _impl_.jwt_token_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\40\0\11\0\0\0\0\0"
    "provisioning.DeleteDeviceRequest"
    "jwt_token"
  }},
};
...
::uint8_t* DeleteDeviceRequest::_InternalSerialize(
  ...
  if (!this->_internal_jwt_token().empty()) {
    const std::string& _s = this->_internal_jwt_token();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "provisioning.DeleteDeviceRequest.jwt_token");
    target = stream->WriteStringMaybeAliased(2, _s, target);
  }
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 3, 1, 50, 2> UpdateDeviceRequest::_table_ = {
  {
    ...
    // string jwt_token = 3;
    {::_pbi::TcParser::FastUS1,
     {26, 63, 0, PROTOBUF_FIELD_OFFSET(UpdateDeviceRequest, _impl_.jwt_token_)}},
  }}, {{
    65535, 65535
  }}, {{
    // int32 device_id = 1;
    ...
    // string jwt_token = 3;
    {PROTOBUF_FIELD_OFFSET(UpdateDeviceRequest, _impl_.jwt_token_), -1, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }}, {{
    {::_pbi::TcParser::GetTable<::provisioning::DeviceInfo>()},
  }}, {{
    "\40\0\0\11\0\0\0\0"
    "provisioning.UpdateDeviceRequest"
    "jwt_token"
  }},
};
...
::uint8_t* UpdateDeviceRequest::_InternalSerialize(
  ...
  if (!this->_internal_jwt_token().empty()) {
    const std::string& _s = this->_internal_jwt_token();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "provisioning.UpdateDeviceRequest.jwt_token");
    target = stream->WriteStringMaybeAliased(3, _s, target);
  }
...
inline PROTOBUF_NDEBUG_INLINE GetDevicesRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from)
      : jwt_token_(arena, from.jwt_token_),
        _cached_size_{0} {}
...
GetDevicesRequest::~GetDevicesRequest() {
  // @@protoc_insertion_point(destructor:provisioning.GetDevicesRequest)
  _internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  SharedDtor();
}
...
PROTOBUF_NOINLINE void GetDevicesRequest::Clear() {
// @@protoc_insertion_point(message_clear_start:provisioning.GetDevicesRequest)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetDevicesRequest::_InternalParse(
    const char* ptr, ::_pbi::ParseContext* ctx) {
  ptr = ::_pbi::TcParser::ParseLoop(this, ptr, ctx, &_table_.header);
  return ptr;
}
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 0, 48, 2> GetDevicesRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    0,  // num_aux_entries
    offsetof(decltype(_table_), field_names),  // no aux_entries
    &_GetDevicesRequest_default_instance_._instance,
    ::_pbi::TcParser::GenericFallback,  // fallback
  }, {{
    // string jwt_token = 1;
    {::_pbi::TcParser::FastUS1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(GetDevicesRequest, _impl_.jwt_token_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string jwt_token = 1;
    {PROTOBUF_FIELD_OFFSET(GetDevicesRequest, _impl_.jwt_token_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\36\11\0\0\0\0\0\0"
    "provisioning.GetDevicesRequest"
    "jwt_token"
  }},
};
...
::uint8_t* GetDevicesRequest::_InternalSerialize(
    ::uint8_t* target,
    ::google::protobuf::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:provisioning.GetDevicesRequest)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_jwt_token().empty()) {
    const std::string& _s = this->_internal_jwt_token();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "provisioning.GetDevicesRequest.jwt_token");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:provisioning.GetDevicesRequest)
  return target;
}

::size_t GetDevicesRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:provisioning.GetDevicesRequest)
  ::size_t total_size = 0;
...
const ::google::protobuf::Message::ClassData GetDevicesRequest::_class_data_ = {
    GetDevicesRequest::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* GetDevicesRequest::GetClassData() const {
  return &_class_data_;
}

void GetDevicesRequest::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  auto* const _this = static_cast<GetDevicesRequest*>(&to_msg);
  auto& from = static_cast<const GetDevicesRequest&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:provisioning.GetDevicesRequest)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:provisioning.GetDevicesRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

PROTOBUF_NOINLINE bool GetDevicesRequest::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* GetDevicesRequest::AccessCachedSize() const {
  return &_impl_._cached_size_;
}
void GetDevicesRequest::InternalSwap(GetDevicesRequest* PROTOBUF_RESTRICT other) {
  using std::swap;
  auto* arena = GetArena();
  ABSL_DCHECK_EQ(arena, other->GetArena());
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
GetDeviceByIdRequest::GetDeviceByIdRequest(
    ::google::protobuf::Arena* arena,
    const GetDeviceByIdRequest& from)
    : ::google::protobuf::Message(arena) {
  GetDeviceByIdRequest* const _this = this;
  (void)_this;
  _internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(
      from._internal_metadata_);
  new (&_impl_) Impl_(internal_visibility(), arena, from._impl_);
  ...
  // @@protoc_insertion_point(copy_constructor:provisioning.GetDeviceByIdRequest)
}
inline PROTOBUF_NDEBUG_INLINE GetDeviceByIdRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 51, 2> GetDeviceByIdRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    2, 8,  // max_field_number, fast_idx_mask
    ...
    // string jwt_token = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(GetDeviceByIdRequest, _impl_.jwt_token_)}},
    // int32 device_id = 1;
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
    // string jwt_token = 2;
    {PROTOBUF_FIELD_OFFSET(GetDeviceByIdRequest, _impl_.jwt_token_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\41\0\11\0\0\0\0\0"
    "provisioning.GetDeviceByIdRequest"
    "jwt_token"
  }},
};
...
::uint8_t* GetDeviceByIdRequest::_InternalSerialize(
  ...
  if (!this->_internal_jwt_token().empty()) {
    const std::string& _s = this->_internal_jwt_token();
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "provisioning.GetDeviceByIdRequest.jwt_token");
    target = stream->WriteStringMaybeAliased(2, _s, target);
  }
